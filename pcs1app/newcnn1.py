...
def read_dataset(path):
    ...
    label_list = []
    i=0
    my_list = os.listdir(r'C:\Users\arjul\PycharmProjects\pcs1\static\dataset')
    for pa in my_list:

        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'C:\Users\arjul\PycharmProjects\pcs1\static\dataset\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\arjul\PycharmProjects\pcs1\static\dataset\\'+pa, f)
            # print(file_path)
...
# # load dataset
# x_dataset, y_dataset = read_dataset(r"C:\Users\arjul\PycharmProjects\pcs1\static\dataset")
...
def predictcnn(fn):
    ...
    dataset=dataset/255
    mo = load_model(r"C:\Users\arjul\PycharmProjects\pcs1\pcs1app\model1.h5")
...
# print(predictcnn(r"C:\Users\arjul\PycharmProjects\pcs1\static\dataset\e\images (2).jpg"),"===========")